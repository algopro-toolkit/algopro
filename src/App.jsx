...
const App = () => {
  ...
  const instagramUrl = "https://www.instagram.com/algopro.toolkit";
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-slate-200 font-sans antialiased">
      ...
      <section id="download" className="py-32 bg-emerald-500 text-center text-black">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl md:text-8xl font-black mb-10 tracking-tighter">準備好了嗎？</h2>
          <a 
            href={appStoreUrl}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex px-16 py-7 bg-black text-white font-black rounded-[2rem] hover:scale-105 transition-all shadow-2xl items-center gap-4 text-2xl"
          >
